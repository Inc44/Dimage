...
![Stars](https://img.shields.io/github/stars/Inc44/Dimage?style=social)
![Forks](https://img.shields.io/github/forks/Inc44/Dimage?style=social)
![Watchers](https://img.shields.io/github/watchers/Inc44/Dimage?style=social)
![Repo Size](https://img.shields.io/github/repo-size/Inc44/Dimage)
![Language Count](https://img.shields.io/github/languages/count/Inc44/Dimage)
![Top Language](https://img.shields.io/github/languages/top/Inc44/Dimage)
[![Issues](https://img.shields.io/github/issues/Inc44/Dimage)](https://github.com/Inc44/Dimage/issues?q=is%3Aopen+is%3Aissue)
![Last Commit](https://img.shields.io/github/last-commit/Inc44/Dimage?color=red)
[![Release](https://img.shields.io/github/release/Inc44/Dimage.svg)](https://github.com/Inc44/Dimage/releases)
...
_If you install only the dependencies, run the program using_ `python -m dimage.cli` _(or_ `python -OO dimage/cli.py`_) instead of the_ `dimage` _command._
...
[DiscordChatExporter](https://github.com/Tyrrrz/DiscordChatExporter) supports only message exporting. Discord media links expire after 24 hours, making media preservation with exported JSON impossible. So, in February 2025, I decided to create the original version of this tool to download all media assets from exported JSON files before links expire, enabling message importing with [Dimport](https://github.com/Inc44/Dimport).
